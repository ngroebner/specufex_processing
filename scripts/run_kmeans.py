...
sgram_catPath = projectPath + f'sgram_cat_out_{key}.csv' #sgram_cat_out_GeysersNW.csv
...
# numPCA = 3
sklearn_pca, PCA_df, Y_pca = funclust.PCAonFP(X,cat0,numPCA=numPCA,stand=True)
...
### This will change if there are new methods for defining Kopt
if K_save == 'K_opt':
    runSilhouette = 'True'
